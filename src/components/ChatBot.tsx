  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-32 right-6 w-16 h-16 rounded-full flex items-center justify-center hover:scale-105 transition-transform z-50"
      >
        {open ? <X className="w-6 h-6" /> : <img src="/customerService.png" alt="Customer Service" className="w-10 h-10 object-contain" />}
      </button>
    </>
  );
};
